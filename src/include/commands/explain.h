...
extern void UpdateExecutionTimesRecursive(std::unordered_map<int, knl_plan_info_context> &Plans, int plan_id);
...
extern void get_join_plan_info(knl_plan_info_context& plan_info, Join *joinplan);
...
extern void InitPlanInfo(knl_plan_info_context &plan_info, knl_query_info_context* query_info);
